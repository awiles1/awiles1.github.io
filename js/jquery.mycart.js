    ...
    var loadMyCartEvent = function(targetSelector) {
        ...
        var drawTable = function() {
            ...
            $.each(products, function() {
                ...
                $cartTable.append('<tr title="' + this.summary + '" data-id="' + this.id + '" data-price="' + this.price + '">' + '<td>' + this.name + '</td>' + '<td title="Unit Price">' + options.currencySymbol + MathHelper.getRoundedNumber(this.price) + '</td>' + '<td title="Quantity"><input type="number" min="1" class="' + classProductQuantity + '" value="' + this.quantity + '"/></td>' + '<td title="Total" class="' + classProductTotal + '">' + options.currencySymbol + MathHelper.getRoundedNumber(total) + '</td>' + '<td title="Remove from Cart" style="width: 30px;"><a href="javascript:void(0);" class="btn btn-danger ' + classProductRemove + '">X</a></td>' + '</tr>')
            });
